...
pub struct Postac {
    pub imie: String,
    pub poziom: u8,
    pub doswiadczenie: u32,
    pub kasa: (u32, u32, u32, u32),
    pub klasa: Klasa,
    pub rasa: Rasa,
    ...
    pub umiejetnosci: HashMap<String, Korzysc>,
    pub atuty: HashMap<String, Korzysc>,
    pub inicjatywa: u8,
    pub rzuty_obronne: (u8, u8, u8),
    pub zwarcie: u8,
    pub jezyki: HashSet<String>,
    //nazwa, waga, obrazenia, krytyk, zasieg, specjalne, opis
    pub bronie: HashMap<String, (f32, Rzut, (u8, u8), u8, Korzysc, String)>,
    //nazwa, waga, premia do KP, specjalne, opis
    pub wyposazenie: HashMap<String, (f32, u8, Korzysc, String)>,
    //nazwa, waga, ilosc
    pub ekwipunek_schowany: HashMap<String, (f32, u16)>,
}
